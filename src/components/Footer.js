        ...
        <div>
          ...
          <ul className="tweets">
            ...
            <li className="tweet">
              ...
              <p>
                Late to the game but <span>Automator</span> is such a life saver
                on productivity. A Figma plugin that serves as a low-code
                platform, you can create your own script with the actions
                provided. Has community too!
              </p>
              <div className="controls">
                <img
                  src="data:image/svg+xml,%3Csvg width='20' height='20' viewBox='0 0 20 20' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M2.5 9.58333C2.49713 10.6832 2.75411 11.7682 3.25 12.75C3.83797 13.9265 4.74188 14.916 5.86046 15.6077C6.97904 16.2995 8.26813 16.6662 9.58333 16.6667C10.6832 16.6695 11.7682 16.4126 12.75 15.9167L17.5 17.5L15.9167 12.75C16.4126 11.7682 16.6695 10.6832 16.6667 9.58333C16.6662 8.26813 16.2995 6.97904 15.6077 5.86046C14.916 4.74187 13.9265 3.83797 12.75 3.25C11.7682 2.75411 10.6832 2.49713 9.58333 2.5H9.16667C7.42971 2.59583 5.78913 3.32897 4.55905 4.55905C3.32897 5.78913 2.59583 7.42971 2.5 9.16667V9.58333Z' stroke='black' stroke-opacity='0.32' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'/%3E%3C/svg%3E%0A"
            ...
            <li className="tweet">
              ...
              <p>
                Been trying out <span>Automator</span>. It's a game-changer for
                us who work on Figma. Just thinking of all the tasks you can
                automate with little-to-no time (0 code)... It's worth every
                penny spent on it. Also, make it lets you create stunning
                designs!
              </p>
              <div className="controls">
                <img
            ...
            <li className="tweet">
              ...
              <p>
                <span>Automator</span> is by far the best money I ever spent on
                a design related tool. Worth way way more than its price tag.
              </p>
              <div className="controls">
                <img
                  src="data:image/svg+xml,%3Csvg width='20' height='20' viewBox='0 0 20 20' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M2.5 9.58333C2.49713 10.6832 2.75411 11.7682 3.25 12.75C3.83797 13.9265 4.74188 14.916 5.86046 15.6077C6.97904 16.2995 8.26813 16.6662 9.58333 16.6667C10.6832 16.6695 11.7682 16.4126 12.75 15.9167L17.5 17.5L15.9167 12.75C16.4126 11.7682 16.6695 10.6832 16.6667 9.58333C16.6662 8.26813 16.2995 6.97904 15.6077 5.86046C14.916 4.74187 13.9265 3.83797 12.75 3.25C11.7682 2.75411 10.6832 2.49713 9.58333 2.5H9.16667C7.42971 2.59583 5.78913 3.32897 4.55905 4.55905C3.32897 5.78913 2.59583 7.42971 2.5 9.16667V9.58333Z' stroke='black' stroke-opacity='0.32' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'/%3E%3C/svg%3E%0A"
